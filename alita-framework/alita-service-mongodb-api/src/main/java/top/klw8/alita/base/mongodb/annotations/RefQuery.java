 ...
 * @Description: 用于标注需要从其他表查询的数据(该数据的类型必须为 BaseBean 的子类)
 * 【注意】:该注解只查询第一层,即: 
...
public @interface RefQuery {
     ...
     * @author klw
     * @Description: 对应实体中哪个字段保存了当前实体中某个标识
     * @return
     */
     ...
     * @Title: refFieldName
     * @author klw
     * @Description: 保存的是当前实体的哪个字段的值,如果为空则用ID
     * @return
     */
     ...
     * @Title: sortFiled
     * @author klw
     * @Description: 根据目标实体的哪个字段排序: 默认 id
     * @return
     */
