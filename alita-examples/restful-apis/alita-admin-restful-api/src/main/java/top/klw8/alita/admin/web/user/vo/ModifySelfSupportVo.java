...
/**
 * @ClassName: ModifySelfSupportVo
 * @Description: 修改自营人员 VO
 * @author klw
 * @date 2019-01-25 16:25:44
 */
@Getter
@Setter
public class ModifySelfSupportVo implements IBaseCrudVo<StaffInfo> {

    
    @ApiModelProperty(value = "要修改的自营人员的ID", required=true)
    @Required(validatFailMessage = "要修改的自营人员的ID不能为空")
    @NotEmpty(validatFailMessage = "要修改的自营人员的ID不能为空")
    private Long id;
